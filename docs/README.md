...
- **[CLI Commands](api/cli.md)** - Command line tools
...
|---------|-------------|----------|
| **[Getting Started](getting-started/)** | Installation, quick start, basics | New users |
| **[Architecture](architecture/)** | System design, components, patterns | Architects, advanced users |
| **[Plugin Development](plugins/)** | Building plugins, APIs, testing | Plugin developers |
| **[API Reference](api/)** | Complete API documentation | Developers, integrators |
| **[Deployment](deployment/)** | Production deployment guides | DevOps, administrators |
| **[Guides](guides/)** | Examples, best practices, troubleshooting | All users |
...
| Production deploy | [Production Setup](deployment/production.md) | 45 min |
...
4. [Security Hardening](deployment/security.md)
...
- **Going to production?** → [Deployment Guide](deployment/docker.md)
