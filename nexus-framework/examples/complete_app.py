...
This example demonstrates a full-featured application built with the Nexus Framework pip package.
...
# Nexus Framework imports (installed via pip install nexus-framework)
from nexus import (
    create_nexus_app,
    BasePlugin,
    PluginMetadata,
...
if __name__ == "__main__":
    print("=" * 60)
    print("🎯 NEXUS FRAMEWORK COMPLETE EXAMPLE")
    print("=" * 60)
    print("📦 Installation: pip install nexus-framework")
